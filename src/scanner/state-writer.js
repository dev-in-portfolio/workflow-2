...
function writeRuntimeSnapshot(state, closureVars) {
  ...
  writeScannerRuntimeState({
    ...
    account_truth: portfolio?.account ? {
      equity: Number.isFinite(Number(portfolio.account.equity)) ? Number(portfolio.account.equity) : null,
      previous_equity: Number.isFinite(Number(portfolio.account.last_equity)) ? Number(portfolio.account.last_equity) : null,
      portfolio_value: Number.isFinite(Number(portfolio.account.portfolio_value)) ? Number(portfolio.account.portfolio_value) : null,
      long_market_value: Number.isFinite(Number(portfolio.account.long_market_value)) ? Number(portfolio.account.long_market_value) : null,
      cash: Number.isFinite(Number(portfolio.account.cash)) ? Number(portfolio.account.cash) : null,
      buying_power: Number.isFinite(Number(portfolio.account.buying_power)) ? Number(portfolio.account.buying_power) : null,

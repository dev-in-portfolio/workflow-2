...
const SCANNER_CONFIG_KEYS = [
  'apiKeyId', 'apiSecretKey', 'baseUrl', 'twelveDataApiKey', 'twelveDataEnabled', 'twelveDataBaseUrl',
  'twelveDataTimeoutMs', 'twelveDataCacheSeconds', 'twelveDataMaxRequestsPerMinute',
  'twelveDataMaxDailyCredits', 'twelveDataDailyReserveCredits', 'twelveDataMaxSymbolsPerCycle',
  'twelveDataMaxPriceDifferencePct', 'twelveDataMaxStalenessSeconds',
  ...
  'minRecentCloseLocationPct', 'requireRecentMove',
...
function buildScannerConfig(env = process.env) {
  ...
  return {
    ...
    twelveDataEnabled: parseBool(env.TWELVE_DATA_ENABLED, false),
    twelveDataBaseUrl: trimTrailingSlash(env.TWELVE_DATA_BASE_URL || 'https://api.twelvedata.com'),
    twelveDataTimeoutMs: Math.max(100, safeNumber(env.TWELVE_DATA_TIMEOUT_MS, 5000)),
    twelveDataCacheSeconds: Math.max(0, safeNumber(env.TWELVE_DATA_CACHE_SECONDS, 60)),
    twelveDataMaxRequestsPerMinute: Math.max(1, safeNumber(env.TWELVE_DATA_MAX_REQUESTS_PER_MINUTE, 8)),
    twelveDataMaxDailyCredits: Math.max(1, safeNumber(env.TWELVE_DATA_MAX_DAILY_CREDITS, 800)),
    twelveDataDailyReserveCredits: Math.max(0, safeNumber(env.TWELVE_DATA_DAILY_RESERVE_CREDITS, 40)),
    twelveDataMaxSymbolsPerCycle: Math.max(0, safeNumber(env.TWELVE_DATA_MAX_SYMBOLS_PER_CYCLE, 2)),
    twelveDataMaxPriceDifferencePct: Math.max(0, safeNumber(env.TWELVE_DATA_MAX_PRICE_DIFFERENCE_PCT, 0.5)),
    twelveDataMaxStalenessSeconds: Math.max(1, safeNumber(env.TWELVE_DATA_MAX_STALENESS_SECONDS, 90)),
    ...
    requireMultiSourceConfirmation: parseBool(env.TWELVE_DATA_ENABLED, false),
    ...
    minPrice: Math.max(0.01, safeNumber(env.STOCK_SCANNER_MIN_PRICE, 0.01)),
    ...
    requireRecentMove: parseBool(env.STOCK_SCANNER_REQUIRE_RECENT_MOVE, false),
    ...
    sessionGuardsEnabled: parseBool(env.SESSION_GUARDS_ENABLED, stricterLiveEntryDefaults),

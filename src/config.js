...
const DEFAULTS = {
  ...
  BUYING_POWER_MARKET_ORDER_BUFFER_PCT: 0,
  ...
  DATA_PROVIDER_FUNDAMENTALS: 'fmp',
  ...
  TWELVE_DATA_TIMEOUT_MS: 5000,
  TWELVE_DATA_CACHE_SECONDS: 60,
  TWELVE_DATA_MAX_REQUESTS_PER_MINUTE: 8,
  TWELVE_DATA_MAX_DAILY_CREDITS: 800,
  TWELVE_DATA_DAILY_RESERVE_CREDITS: 40,
  TWELVE_DATA_MAX_SYMBOLS_PER_CYCLE: 2,
  TWELVE_DATA_MAX_PRICE_DIFFERENCE_PCT: 0.5,
  TWELVE_DATA_MAX_STALENESS_SECONDS: 90,
  SEC_EDGAR_ENABLED: false,
  SEC_EDGAR_USER_AGENT: '',
  SEC_EDGAR_BASE_URL: 'https://data.sec.gov',
  SEC_EDGAR_ARCHIVES_BASE_URL: 'https://www.sec.gov',
  SEC_EDGAR_TIMEOUT_MS: 5000,
  SEC_EDGAR_CACHE_SECONDS: 300,
  SEC_EDGAR_MAX_REQUESTS_PER_SECOND: 5,
  SEC_EDGAR_MAX_SYMBOLS_PER_CYCLE: 20,
  SEC_EDGAR_LOOKBACK_DAYS: 5,
  MASSIVE_ENABLED: false,
  MASSIVE_API_KEY: '',
  POLYGON_API_KEY: '',
  MASSIVE_BASE_URL: 'https://api.massive.com',
  MASSIVE_TIMEOUT_MS: 5000,
  MASSIVE_CACHE_SECONDS: 60,
  MASSIVE_MAX_REQUESTS_PER_MINUTE: 5,
  MASSIVE_MAX_SYMBOLS_PER_CYCLE: 2,
  MASSIVE_MAX_STALENESS_SECONDS: 90,
  MASSIVE_MAX_PRICE_DIFFERENCE_PCT: 0.5,
  FINNHUB_ENABLED: false,
  FINNHUB_API_KEY: '',
  FINNHUB_BASE_URL: 'https://finnhub.io/api/v1',
  FINNHUB_TIMEOUT_MS: 5000,
  FINNHUB_CACHE_SECONDS: 60,
  FINNHUB_MAX_REQUESTS_PER_MINUTE: 30,
  FINNHUB_MAX_SYMBOLS_PER_CYCLE: 2,
  FINNHUB_MAX_STALENESS_SECONDS: 90,
  FINNHUB_MAX_PRICE_DIFFERENCE_PCT: 0.5,
  FMP_ENABLED: false,
  FMP_API_KEY: '',
  FMP_BASE_URL: 'https://financialmodelingprep.com',
  FMP_TIMEOUT_MS: 5000,
  FMP_CACHE_SECONDS: 3600,
  FMP_MAX_REQUESTS_PER_DAY: 250,
  FMP_DAILY_RESERVE_REQUESTS: 25,
  FMP_MAX_SYMBOLS_PER_CYCLE: 20,
  REDDIT_CLIENT_ID: '',
  ...
  REGULAR_WATCH_MAX_SYMBOLS_PER_RUN: 1000,
  REGULAR_WATCH_MARKET_DATA_BATCH_SIZE: 100,
  REGULAR_WATCH_DISPLAY_LIMIT: 100,
  REGULAR_WATCH_FAST_LANE_ENABLED: true,
  REGULAR_WATCH_FAST_LANE_LIMIT: 250,
...
const CONFIG_SCHEMA = [
  ...
  ['STOCK_SCANNER_MIN_PRICE', 'number', 0.01, { positive: true }],
  ...
  ['POSITION_SIZING_MODE', 'string', 'fixed_notional', { enum: ['fixed_notional', 'risk_budget', 'buying_power'], lower: true }],
  ['MAX_BUYING_POWER_DEPLOYMENT_PCT', 'number', 100, { range: [0, 100] }],
  ['BUYING_POWER_MARKET_ORDER_BUFFER_PCT', 'number', 0, { range: [0, 50] }],
  ['BUYING_POWER_CASH_RESERVE', 'number', 0, { nonNegative: true }],
  ['ALLOW_BUYING_POWER_FRACTIONAL_SHARES', 'bool', false],
  ...
  ['DATA_PROVIDER_FALLBACK', 'string', ''],
  ['DATA_PROVIDER_FUNDAMENTALS', 'string', 'fmp'],
  ...
  ['TWELVE_DATA_BASE_URL', 'string', 'https://api.twelvedata.com'],
  ['TWELVE_DATA_TIMEOUT_MS', 'number', 5000, { positive: true }],
  ['TWELVE_DATA_CACHE_SECONDS', 'number', 60, { nonNegative: true }],
  ['TWELVE_DATA_MAX_REQUESTS_PER_MINUTE', 'number', 8, { positive: true }],
  ['TWELVE_DATA_MAX_DAILY_CREDITS', 'number', 800, { positive: true }],
  ['TWELVE_DATA_DAILY_RESERVE_CREDITS', 'number', 40, { nonNegative: true }],
  ['TWELVE_DATA_MAX_SYMBOLS_PER_CYCLE', 'number', 2, { nonNegative: true }],
  ['TWELVE_DATA_MAX_PRICE_DIFFERENCE_PCT', 'number', 0.5, { range: [0, 100] }],
  ['TWELVE_DATA_MAX_STALENESS_SECONDS', 'number', 90, { positive: true }],
  ['SEC_EDGAR_ENABLED', 'bool', false],
  ['SEC_EDGAR_USER_AGENT', 'string', ''],
  ['SEC_EDGAR_BASE_URL', 'string', 'https://data.sec.gov'],
  ['SEC_EDGAR_ARCHIVES_BASE_URL', 'string', 'https://www.sec.gov'],
  ['SEC_EDGAR_TIMEOUT_MS', 'number', 5000, { positive: true }],
  ['SEC_EDGAR_CACHE_SECONDS', 'number', 300, { nonNegative: true }],
  ['SEC_EDGAR_MAX_REQUESTS_PER_SECOND', 'number', 5, { positive: true }],
  ['SEC_EDGAR_MAX_SYMBOLS_PER_CYCLE', 'number', 20, { nonNegative: true }],
  ['SEC_EDGAR_LOOKBACK_DAYS', 'number', 5, { nonNegative: true }],
  ['MASSIVE_ENABLED', 'bool', false],
  ['MASSIVE_API_KEY', 'string', ''],
  ['POLYGON_API_KEY', 'string', ''],
  ['MASSIVE_BASE_URL', 'string', 'https://api.massive.com'],
  ['MASSIVE_TIMEOUT_MS', 'number', 5000, { positive: true }],
  ['MASSIVE_CACHE_SECONDS', 'number', 60, { nonNegative: true }],
  ['MASSIVE_MAX_REQUESTS_PER_MINUTE', 'number', 5, { positive: true }],
  ['MASSIVE_MAX_SYMBOLS_PER_CYCLE', 'number', 2, { nonNegative: true }],
  ['MASSIVE_MAX_STALENESS_SECONDS', 'number', 90, { positive: true }],
  ['MASSIVE_MAX_PRICE_DIFFERENCE_PCT', 'number', 0.5, { range: [0, 100] }],
  ['FINNHUB_ENABLED', 'bool', false],
  ['FINNHUB_API_KEY', 'string', ''],
  ['FINNHUB_BASE_URL', 'string', 'https://finnhub.io/api/v1'],
  ['FINNHUB_TIMEOUT_MS', 'number', 5000, { positive: true }],
  ['FINNHUB_CACHE_SECONDS', 'number', 60, { nonNegative: true }],
  ['FINNHUB_MAX_REQUESTS_PER_MINUTE', 'number', 30, { positive: true }],
  ['FINNHUB_MAX_SYMBOLS_PER_CYCLE', 'number', 2, { nonNegative: true }],
  ['FINNHUB_MAX_STALENESS_SECONDS', 'number', 90, { positive: true }],
  ['FINNHUB_MAX_PRICE_DIFFERENCE_PCT', 'number', 0.5, { range: [0, 100] }],
  ['FMP_ENABLED', 'bool', false],
  ['FMP_API_KEY', 'string', ''],
  ['FMP_BASE_URL', 'string', 'https://financialmodelingprep.com'],
  ['FMP_TIMEOUT_MS', 'number', 5000, { positive: true }],
  ['FMP_CACHE_SECONDS', 'number', 3600, { nonNegative: true }],
  ['FMP_MAX_REQUESTS_PER_DAY', 'number', 250, { positive: true }],
  ['FMP_DAILY_RESERVE_REQUESTS', 'number', 25, { nonNegative: true }],
  ['FMP_MAX_SYMBOLS_PER_CYCLE', 'number', 20, { nonNegative: true }],
  ...
  ['REGULAR_WATCH_UNIVERSE_SOURCE', 'string', 'alpaca_assets'],
  ['REGULAR_WATCH_MAX_SYMBOLS_PER_RUN', 'number', 1000, { positive: true }],
  ['REGULAR_WATCH_MARKET_DATA_BATCH_SIZE', 'number', 100, { positive: true }],
  ['REGULAR_WATCH_DISPLAY_LIMIT', 'number', 100, { positive: true }],
  ['REGULAR_WATCH_FAST_LANE_ENABLED', 'bool', true],
  ['REGULAR_WATCH_FAST_LANE_LIMIT', 'number', 250, { min: 0 }],
...
function loadConfig(env = process.env) {
  ...
  if (config.TWELVE_DATA_ENABLED && !config.TWELVE_DATA_API_KEY) issues.push('TWELVE_DATA_API_KEY_REQUIRED');
  if (config.SEC_EDGAR_ENABLED && !config.SEC_EDGAR_USER_AGENT) issues.push('SEC_EDGAR_USER_AGENT_REQUIRED');
  if (config.MASSIVE_ENABLED && !(config.MASSIVE_API_KEY || config.POLYGON_API_KEY)) issues.push('MASSIVE_API_KEY_REQUIRED');
  if (config.FINNHUB_ENABLED && !config.FINNHUB_API_KEY) issues.push('FINNHUB_API_KEY_REQUIRED');
  if (config.FMP_ENABLED && !config.FMP_API_KEY) issues.push('FMP_API_KEY_REQUIRED');
  if (config.FMP_DAILY_RESERVE_REQUESTS > config.FMP_MAX_REQUESTS_PER_DAY) issues.push('FMP_DAILY_RESERVE_REQUESTS_INVALID');
  if (config.TWELVE_DATA_DAILY_RESERVE_CREDITS > config.TWELVE_DATA_MAX_DAILY_CREDITS) issues.push('TWELVE_DATA_DAILY_RESERVE_CREDITS_INVALID');
